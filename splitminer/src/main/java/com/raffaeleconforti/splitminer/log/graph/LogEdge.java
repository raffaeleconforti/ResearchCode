package com.raffaeleconforti.splitminer.log.graph;
...
public class LogEdge implements Comparable {
    ...
    public void setSource(LogNode source) {
        this.source = source;
    }

    public LogNode getSource() {
        return source;
    }
    ...
    public void setTarget(LogNode target) {
        this.target = target;
    }

    public LogNode getTarget() {
        return target;
    }
