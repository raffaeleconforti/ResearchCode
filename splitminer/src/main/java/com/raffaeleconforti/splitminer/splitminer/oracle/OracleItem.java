...
package com.raffaeleconforti.splitminer.splitminer.oracle;
...
public class OracleItem implements Comparable {
    ...
    public void fillPast(int p) {
        past.add(p);
    }

    public void fillFuture(int f) {
        future.add(f);
    }

    public void fillPast(Collection<Integer> past) {
        this.past.addAll(past);
    }

    public void fillFuture(Collection<Integer> future) {
        this.future.addAll(future);
    }

    public Set<OracleItem> getXorBrothers() {
        return xorBrothers;
    }

    public Set<OracleItem> getAndBrothers() {
        return andBrothers;
    }
...
//        it contains all the ordered elements of the past and the future
    ...
    public boolean isXOR(OracleItem oItem) {
        return oItem.oracleFuture.equals(oracleFuture);
    }
    ...
    public boolean isAND(OracleItem oItem) {
        return oItem.oracle.equals(oracle);
    }
...
//        note: we CANNOT have both xorBrothers and andBrothers filled
    ...
    public String toString() {
        return (oraclePast + "|" + oracleFuture);
    }
