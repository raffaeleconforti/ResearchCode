package com.raffaeleconforti.splitminer.splitminer.ui.dfgp;


import static com.raffaeleconforti.splitminer.splitminer.ui.dfgp.DFGPUIResult.FilterType.WTH;
...
public class DFGPUIResult {
    ...
    public boolean isParallelismsFirst() {
        return parallelismsFirst;
    }

    public void setParallelismsFirst(boolean parallelismsFirst) {
