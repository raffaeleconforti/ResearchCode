...
public class InfrequentBehaviourFilterPluginGurobi extends InfrequentBehaviourFilterPlugin {
...
//    }
    ...
    @PluginVariant(variantLabel = "Infrequent Behaviour Filter Gurobi", requiredParameterLabels = {0})//, 1, 2, 3 })
