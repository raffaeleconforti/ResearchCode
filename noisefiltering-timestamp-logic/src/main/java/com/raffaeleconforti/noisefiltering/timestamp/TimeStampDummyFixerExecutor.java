...
public class TimeStampDummyFixerExecutor {
...
//        while(fix[0] > 0 && count < res.size() / 4) {
            ...
            TimeStampFixer timeStampFixerDummy = new TimeStampFixerDummy(new XFactoryNaiveImpl(), logCloner, optimizedLog, xEventClassifier, dateFormatSeconds, 0, 0);
...
//            }
            ...
            TimestampsAssigner timestampsAssigner = new TimestampsAssigner(res, xEventClassifier, dateFormatSeconds, timeStampFixerDummy.getDuplicatedTraces(), timeStampFixerDummy.getDuplicatedEvents());
