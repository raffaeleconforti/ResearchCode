 ...
 */
public class TimeStampFixerRandom implements TimeStampFixer {
    ...
    public TimeStampFixerRandom(XFactory factory, LogCloner logCloner, XLog rawlog, XEventClassifier xEventClassifier, SimpleDateFormat dateFormatSeconds, int limitExtensive, int approach, boolean useGurobi, boolean useArcsFrequency) {
