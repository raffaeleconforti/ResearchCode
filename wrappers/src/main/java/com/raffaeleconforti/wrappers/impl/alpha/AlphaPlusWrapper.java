...
public class AlphaPlusWrapper implements MiningAlgorithm {
    ...
    public PetrinetWithMarking minePetrinet(UIPluginContext context, XLog log, boolean structure, MiningSettings params, XEventClassifier xEventClassifier) {
        ...
        // Call the miner
        AlphaMinerParameters parameters = new AlphaPlusMinerParameters(AlphaVersion.PLUS);
