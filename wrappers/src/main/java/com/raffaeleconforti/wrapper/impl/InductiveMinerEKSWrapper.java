 ...
 */
@Plugin(name = "Inductive Miner IMeks Wrapper", parameterLabels = {"Log"},
        returnLabels = {"PetrinetWithMarking"},
        returnTypes = {PetrinetWithMarking.class})
public class InductiveMinerEKSWrapper implements MiningAlgorithm {
    ...
    @PluginVariant(variantLabel = "Inductive Miner IMeks Wrapper", requiredParameterLabels = {0})
